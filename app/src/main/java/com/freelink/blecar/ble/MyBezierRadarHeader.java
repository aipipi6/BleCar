...
public class MyBezierRadarHeader extends InternalAbstract implements RefreshHeader {
        ...
        public MyBezierRadarHeader(Context context, AttributeSet attrs) {
            this(context, attrs,0);
        }

        public MyBezierRadarHeader(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            mDotRadius = density.dip2px(5);
            mRadarRadius = density.dip2px(16);
            mRadarCircle = density.dip2px(5);
            mPaint.setStrokeWidth(density.dip2px(3));

            thisView.setMinimumHeight(density.dip2px(64));
            ...
            TypedArray ta = context.obtainStyledAttributes(attrs, com.scwang.smartrefresh.layout.R.styleable.BezierRadarHeader);

            mEnableHorizontalDrag = ta.getBoolean(com.scwang.smartrefresh.layout.R.styleable.BezierRadarHeader_srlEnableHorizontalDrag, mEnableHorizontalDrag);
            setAccentColor(ta.getColor(com.scwang.smartrefresh.layout.R.styleable.BezierRadarHeader_srlAccentColor, 0xFFffffff));
            setPrimaryColor(ta.getColor(com.scwang.smartrefresh.layout.R.styleable.BezierRadarHeader_srlPrimaryColor, 0xFF222222));
            mManualAccentColor = ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.BezierRadarHeader_srlAccentColor);
            mManualPrimaryColor = ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.BezierRadarHeader_srlPrimaryColor);
...
//    }
        ...
        public MyBezierRadarHeader setPrimaryColor(@ColorInt int color) {
            mPrimaryColor = color;
            mManualPrimaryColor = true;
            return this;
        }

        public MyBezierRadarHeader setAccentColor(@ColorInt int color) {
            mAccentColor = color;
            mManualAccentColor = true;
            return this;
        }

        public MyBezierRadarHeader setPrimaryColorId(@ColorRes int colorId) {
            final View thisView = this;
            setPrimaryColor(getColor(thisView.getContext(), colorId));
            return this;
        }

        public MyBezierRadarHeader setAccentColorId(@ColorRes int colorId) {
            final View thisView = this;
            setAccentColor(getColor(thisView.getContext(), colorId));
            return this;
        }

        public MyBezierRadarHeader setEnableHorizontalDrag(boolean enable) {
        ...
        protected class AnimatorUpdater implements ValueAnimator.AnimatorUpdateListener {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                final View thisView =MyBezierRadarHeader.this;
                thisView.invalidate();
            }
        }
        //</editor-fold>
