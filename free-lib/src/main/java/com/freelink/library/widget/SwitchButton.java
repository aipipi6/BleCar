...
/**
 * Created by chenjun on 2018/7/9.
 */
public class SwitchButton extends View {
    ...
    public SwitchButton(Context context, AttributeSet attrs) {
        ...
        isClickOpen = a.getBoolean(R.styleable.SwitchButton_isClickOpen, true);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (isClickOpen && (state == STATE_SWITCH_ON || state == STATE_SWITCH_OFF) && (sAnim * bAnim == 0)) {
